...
def Escolha():
        ...
        layouts = [[sg.Image(r"E:\git\pytom\WOPOB\resources\branco.png") if values['1']==True else sg.Image(r"E:\git\pytom\WOPOB\resources\preto.png")],
                ...
                # sg.TabGroup([[sg.Tab('Tab 1',People_layouts), sg.Tab('Tab 2',Nature_layouts),sg.Tab('Tab 3',Objects_layouts), sg.Tab('Tab 4',Places_layouts),sg.Tab('Tab 5',Symbols_layouts)]])if values['3']==True else ''],
                [sg.Button('Ok'),
                sg.Button('Cancel')]]
        ...
        while True:
                ...
                if event == 'OK':
                        ...
                        for contato in contatos:#fazer o envio
                                ...
                                sg.SystemTray.notify('Mensagem enviada')
                window2.close()
Escolha()